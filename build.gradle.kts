                ...
                if (findByName("mavenJava") == null) {
                    create<MavenPublication>("mavenJava") {
                        ...
                        pom {
                            ...
                            description.set("S3-VIEWER Spring Boot starter")
                            url.set("https://github.com/OpenProjectX/s3-viewer")
                            ...
                            scm {
                                url.set("https://github.com/OpenProjectX/s3-viewer")
                                connection.set("scm:git:https://github.com/OpenProjectX/s3-viewer.git")
                                developerConnection.set("scm:git:ssh://git@github.com:OpenProjectX/s3-viewer.git")
                            }
                        }
                    }
                }
